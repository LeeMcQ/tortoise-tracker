export const DEMO = {
  ...
  observation_reviews: [
    {id:'rv1', observation_id:'o1', status:'verified', reason:'Clear QR, photo and high accuracy GPS.', reviewer:'Researcher Demo', reviewed_at:'2026-05-04T10:00:00+02:00'},
    {id:'rv2', observation_id:'o2', status:'verified', reason:'Identity confirmed from shell pattern.', reviewer:'Researcher Demo', reviewed_at:'2026-06-17T08:00:00+02:00'}
  ],
  measurements: [
    {id:'m1', animal_id:'a1', measured_at:'2026-03-10T09:30:00+02:00', measurement_type:'mass', value:6.2, unit:'kg', method:'calibrated field scale', confidence:'high', recorded_by:'Researcher Demo'},
    {id:'m2', animal_id:'a1', measured_at:'2026-03-10T09:32:00+02:00', measurement_type:'straight_carapace_length', value:412, unit:'mm', method:'calipers', confidence:'high', recorded_by:'Researcher Demo'},
    {id:'m3', animal_id:'a2', measured_at:'2026-04-02T11:20:00+02:00', measurement_type:'mass', value:2.4, unit:'kg', method:'calibrated field scale', confidence:'high', recorded_by:'Researcher Demo'}
  ],
  health_cases: [
  ...
  health_case_events: [
    {id:'hce1', case_id:'hc1', event_at:'2026-08-08T09:00:00+02:00', event_type:'review', notes:'No obvious trauma in available image. Monitor next sighting.', actor:'Veterinarian Demo'}
  ],
  devices: [
